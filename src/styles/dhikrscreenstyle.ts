...
export const styles = StyleSheet.create({
  ...
  textContainer: { marginBottom: 16, padding: 12, borderRadius: 12, backgroundColor: "#1f2937" },
  activeTextContainer: { backgroundColor: "#2563eb" },
  text: { color: "#e5e7eb", textAlign: "center" },
  activeText: { color: "#fff", fontWeight: "bold" },
  title: { fontSize: 22, color: "#f9fafb", fontWeight: "bold", textAlign: "center" },
  headerRow: { flexDirection: "row", justifyContent: "space-between", paddingHorizontal: 16, alignItems: "center", marginTop: 12 },
  backButton: { backgroundColor: "#374151", padding: 6, borderRadius: 10 },
