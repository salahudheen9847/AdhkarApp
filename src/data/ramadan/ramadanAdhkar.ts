...
// Ramadan adhkar & niyyah set
export const ramadanAdhkar: DhikrItem[] = [
  {
    id: 1,
    isHeading: true,
    isBox: true,
...

  {
    id: 2,
    isBox: false,
    text: "نَوَيْتُ صَوْمَ غَدٍ عَنْ أَدَاءِ فَرْضِ رَمَضَانِ هَذِهِ السَّنَةِ لِلَّهِ تَعَالَى.",
    malayalam:
      "റമളാനിലെ ഓരോ രാവിലും നോമ്പിനുള്ള നിയ്യം: നൊവിറ്റു സൗമ ഗദിന് അൻ അദാഇ ഫർദി റമദാനി ഹാഝിഹിസ്സനതി ലില്ലാഹി തഅാലാ.",
    english:
      "I intend to fast tomorrow to fulfill the obligatory fast of this year’s Ramadan for Allah Most High.",
    start: 0,
    end: 8,
  },
...

  {
    id: 4,
    isBox: false,
    text: "اللَّهُمَّ لَكَ صُمْتُ وَعَلَى رِزْقِكَ أَفْطَرْتُ ، ذَهَبَ الظَّمَأُ وَابْتَلَّتِ الْعُرُوقُ وَثَبَتَ الْأَجْرُ إِنْ شَاءَ الله.",
    malayalam:
      "നോമ്പ് തുറക്കുമ്പോൾ: അല്ലാഹുമ്മ ലക സുമ്തു വ അലാ റിസ്കിക അഫ്തർതു. സഹബൽ സമഅ വബ്‌തല്ലതിൽ ഉരുൿ വ സബതല അജ്രു ഇൻ ഷാഅല്ലാഹ്.",
    english:
...

  {
    id: 6,
    isBox: false,
    text: "أَشْهَدُ أَنْ لَا إِلَهَ إِلَّا اللَّهُ أَسْتَغْفِرُ اللهَ وَأَسْأَلُكَ الْجَنَّةَ وَأَعُوذُ بِكَ مِنَ النَّارِ.",
    malayalam:
...

  {
    id: 8,
    isBox: false,
    text: "اللَّهُمَّ ارْحَمْنِي يَا أَرْحَمَ الرَّاحِمِينَ",
    malayalam:
...

  {
    id: 10,
    isBox: false,
    text: "اللَّهُمَّ اغْفِرْ لِي ذُنُوبِي يَارَبَّ الْعَالَمِينَ",
    malayalam:
...

  {
    id: 12,
    isBox: false,
    text: "اللَّهُمَّ إِنَّكَ عَفُوٌّ تُحِبُّ الْعَفْوَ فَاعْفُ عَنِّي اللَّهُمَّ أَعْتِقْنِي مِنَ النَّارِ وَأَدْخِلْنِي الْجَنَّةَ يَا رَبَّ الْعَالَمِينَ.",
    malayalam:
...

  {
    id: 14,
    isBox: false,
    text: "اللَّهُمَّ اجْعَلْ هَذَا الشَّهْرَ الشَّرِيفَ الْعَظِيمَ شَاهِدًا لَنَا لَا شَاهِدًا عَلَيْنَا وَاجْعَلْهُ حُجَّةً لَنَا لَا حُجَّةً عَلَيْنَا اللَّهُمَّ أَعْتِقْ رِقَابَنَا وَرِقَابَ آبَائِنَا وَأُمَّهَاتِنَا وَمَنْ تَعَلَّقُوا بِنَا مِنَ الدُّيوُنِ وَالْمَظَالِمِ وَالنَّارِ.",
    malayalam:
